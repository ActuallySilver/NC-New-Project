...
exports.selectArticleById = async (id) => {
  const { rows: articles } = await db.query(
    `SELECT articles.article_id, articles.author, articles.body, articles.created_at, articles.title, articles.topic, articles.votes, COUNT(comments.article_id) AS comment_count
     FROM articles
